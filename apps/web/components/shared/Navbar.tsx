        ...
        <div className="flex items-center gap-1.5 ml-auto">
          ...
          {user && (
            <>
              ...
              <Link
                href="/profile/me"
                className="hidden md:flex w-9 h-9 rounded-full border border-border bg-primary/10 items-center justify-center hover:bg-primary/20 transition-colors flex-shrink-0"
                aria-label="Профайл"
              >
